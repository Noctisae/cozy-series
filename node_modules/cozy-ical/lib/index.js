...
module.exports.VCalendar = VCalendar = (function(_super) {
  ...
  VCalendar.prototype.extract = function() {
    var extractPRODID, name, organization, prodId, results, title, value, _;
...
module.exports.VEvent = VEvent = (function(_super) {
  ...
  VEvent.prototype.extract = function(defaultTimezone) {
    var allDay, attendees, created, daysNum, dtend, dtstart, duration, endDate, error, hoursNum, iCalFormat, lastModification, minutesNum, mozLastack, rrule, rruleOptions, secondsNum, stampDate, startDate, timezone, timezoneEnd, timezoneStart, uid, weeksNum, _, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    if ((endDate != null) && (duration != null)) {
      ...
      if (((_ref5 = dtend.details) != null ? _ref5.length : void 0) > 0) {
        _ref6 = dtend.details[0].split('='), _ = _ref6[0], timezoneEnd = _ref6[1];
    ...
    if (rrule != null) {
      ...
      try {
        rrule = rrule.split(';').map(function(part) {
          if (part.indexOf('UNTIL') !== -1 && part[part.length - 1] !== 'Z') {
            part += 'Z';
          }
          return part;
        }).join(';');
